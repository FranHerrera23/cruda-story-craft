  ...
  return (
    <div style={{ backgroundColor: '#FFFFFF' }}>
      ...
      <section
        ...
        style={{
          height: '100vh',
          backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), url(${mikeHero.src})`,
      ...
      <section
        ...
        style={{
          height: '60vh',
          backgroundImage: `url(${mikeCarousel1.src})`,
          backgroundSize: 'cover',
      ...
      <section
        ...
        style={{
          height: '60vh',
          backgroundImage: `url(${mikeCarousel3.src})`,
          backgroundSize: 'cover',
      ...
      <section
        ...
        style={{
          height: '60vh',
          backgroundImage: `url(${mikeCarousel5.src})`,
          backgroundSize: 'cover',
          backgroundPosition: 'center'
        }}
      />
