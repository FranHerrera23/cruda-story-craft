  ...
  return (
    <div style={{ backgroundColor: '#FFFFFF' }}>
      ...
      <section
        ...
        style={{
          height: '70vh',
          backgroundImage: `linear-gradient(to top, rgba(0, 0, 0, 0.6), transparent 60%), url(${porscheExteriorNight.src})`,
      ...
      <section
        className="w-full"
        style={{ height: '50vh', backgroundImage: `url(${porscheShowroom.src})`, backgroundSize: 'cover', backgroundPosition: 'center' }}
      />
      ...
      <section className="py-20 md:py-28 px-6 md:px-20" style={{ backgroundColor: '#F5F1E8' }}>
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="max-w-[500px] mx-auto">
            ...
            >
              <img src={porscheInstagramPost.src} alt="Porsche Instagram post" className="w-full" loading="lazy" />
      ...
      <section className="py-20 md:py-28 px-6 md:px-20 text-center" style={{ backgroundColor: '#F5F1E8' }}>
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/book-call" className="inline-block px-10 py-4 font-semibold transition-all duration-300" style={{ backgroundColor: 'transparent', color: '#0A0A0A', borderRadius: '4px', fontSize: '16px', border: '2px solid #0A0A0A' }}>
