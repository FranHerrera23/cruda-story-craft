        ...
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="max-w-[800px] mx-auto mb-12">
            <div className="overflow-hidden" style={{ backgroundColor: '#FFFFFF', borderRadius: '12px', boxShadow: '0 2px 16px rgba(0, 0, 0, 0.06)' }}>
              ...
              <div className="p-6">
                <h3 style={{ fontSize: '18px', fontWeight: 600, color: '#000000', marginBottom: '4px' }}>Porsche Flagship Peru</h3>
          ...
          <div className="max-w-[500px] mx-auto">
            ...
            >
              ...
              <div className="p-6 text-center">
                <span className="text-sm font-medium" style={{ color: '#E8623A' }}>View on Instagram →</span>
              </div>
            </a>
          </div>
        </div>
