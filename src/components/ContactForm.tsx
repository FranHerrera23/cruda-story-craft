...
const ContactForm = () => {
  return (
    <section id="contact" className="py-20 md:py-24 px-6 md:px-16" style={{ backgroundColor: '#FDFBF7' }}>
      <div className="max-w-[800px] mx-auto text-center">
        <h2 className="font-display text-[32px] md:text-[42px] font-bold leading-[1.15] tracking-tight-2 mb-8" style={{ color: '#3D3835' }}>
        ...
        <div className="mt-12 pt-12 border-t" style={{ borderColor: 'rgba(61, 56, 53, 0.15)' }}>
          <p className="text-sm mb-4" style={{ color: 'rgba(61, 56, 53, 0.6)' }}>
