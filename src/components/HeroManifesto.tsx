...
const HeroManifesto = () => {
  return (
    <section className="relative min-h-screen bg-charcoal text-bone overflow-hidden">
      <div className="grid md:grid-cols-[55%_45%] gap-10 md:gap-20 min-h-screen items-center px-6 md:px-20 py-20 md:py-0">
        ...
        <div className="max-w-[600px] order-2 md:order-1">
          ...
          <p className="text-lg md:text-xl font-normal text-bone/70 leading-[1.7] mb-16 slow-fade-in" style={{ animationDelay: '1.8s' }}>
            We work with founders who've mastered their craft — but need help articulating what makes their work different.
          </p>

          <p className="text-base md:text-lg font-normal text-bone/50 leading-[1.6] mb-20 slow-fade-in" style={{ animationDelay: '2.3s' }}>
