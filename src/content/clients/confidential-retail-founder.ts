...
export const confidentialRetailFounder: CaseStudy = {
  ...
  sections: [
    ...
    {
      heading: 'Second-time founder, sharper systems.',
      body: [
        "First company: fast growth, operational chaos. Second company: controlled growth, systems-first. CRUDA positioned this founder not as a repeat operator, but as someone who has changed the way the model is built. That is a different claim, and it travels differently.",
      ],
    },
    {
