...
/* ------------------------------------------------------------------
   Las siglas que usás para no decir "gente" — verbatim del original.
   Publicado 29 julio 2026. Idioma: español.
   No editar el cuerpo. La bio de Bayala (W+K Portland/Ámsterdam,
   Madre BA, Mother Londres, New con Alex Pentland del MIT) está
   verificada contra Fundación Konex, Adlatina y La Nación — no
   tocar per brief v10.
------------------------------------------------------------------- */

export const siglasParaNoDecirGente: Essay = {
  slug: 'siglas-para-no-decir-gente',
  language: 'es',
  category: 'Lenguaje',
  contentType: 'Essay',
  readingMinutes: 7,
  ...
  title: 'Las siglas que usás para no decir "gente"',
  ...
  body: [
    ...
    },
    {
      type: 'p',
      html:
        'Lo que dijo es bastante simple: qué fea que es la palabra <em>consumer</em>. Consumidor. Usuario.',
    },
    {
      type: 'p',
      text:
    ...
    { type: 'h2', text: 'El idioma que armamos para no decir "gente"' },
    ...
    },
    {
      type: 'p',
      html:
        'Nada de eso es mentira, y ninguna de esas palabras está mal usada. El problema es otro: <strong>en toda esa conversación no apareció una sola persona.</strong>',
    },
    {
      type: 'p',
      text:
    ...
    { type: 'p', text: 'Mirá qué dice cada una en realidad.' },
    {
      type: 'p',
      html:
        '<em>Lead</em> significa pista, indicio, algo que te conduce a otra parte. La palabra define a esa persona exclusivamente por adónde te lleva.',
    },
    {
      type: 'p',
      html:
        '<em>Churn</em> significa agitación, revoltijo. Se usa para nombrar a alguien que decidió irse. Alguien que un día confió en vos, pagó, probó, y en algún momento decidió que no valía la pena. Todo eso queda envuelto en una palabra que suena a estadística meteorológica.',
    },
    {
      type: 'p',
      html:
        '<em>Retención</em> es todavía más brutal si la mirás de frente: retener es impedir que algo se vaya. Es la palabra que se usa para líquidos, para documentos y para personas detenidas.',
    },
    {
      type: 'p',
      html:
        '<em>Base</em> los convierte en una superficie sobre la que apoyarte.',
    },
    {
      type: 'p',
      html:
        '<em>Tráfico</em> los convierte en autos pasando.',
    },
    {
      type: 'p',
      html:
        'Y <em>conversión</em>, que es la más usada de todas, describe el momento en que alguien confía en vos como si fuera un cambio de estado químico.',
    },

    { type: 'h2', text: 'Por qué esto no es una queja estética' },
    ...
    { type: 'h2', text: 'No es solo cómo nombrás al cliente' },
    ...
    },
    {
      type: 'p',
      html:
        'Y todas estas palabras tienen algo en común: <strong>son cómodas.</strong> Es más fácil recortar un head count que despedir a Sergio. Es más fácil escribirle un mail duro a un usuario moroso que a Marcela, que tiene dos hijos, un local en Vicente López, y este mes le fue mal.',
    },
    {
      type: 'p',
      text:
    ...
    { type: 'h2', text: 'La pregunta que hago siempre' },
    ...
    },
    {
      type: 'p',
      html:
        'Y después la que importa de verdad: <strong>¿sabés por qué te compran?</strong>',
    },
    {
      type: 'p',
      text:
    ...
    { type: 'h2', text: 'Lo que no se puede fingir' },
    ...
    { type: 'p', text: 'Pero dos cosas para mirar esta semana.' },
    {
      type: 'p',
      html:
        '<strong>¿Cómo nombran ustedes, internamente, a la gente que les compra?</strong> No en la web. En el chat del equipo, en la reunión de los lunes, en el documento de estrategia. Esa palabra se va a filtrar a todo lo demás, y no al revés.',
    },
    {
      type: 'p',
      html:
        '<strong>¿Y sabés por qué te eligieron?</strong> Agarrá los últimos cinco clientes y tratá de contestar, uno por uno, cuál fue la fibra. Si no lo sabés, preguntáselos. Es la conversación más barata y más rentable que vas a tener este mes.',
    },
