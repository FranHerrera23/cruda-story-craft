...
export const mikeKaeding: Work = {
  ...
  metrics: [
    ...
    { value: '2M', label: 'impressions a year', source: 'LinkedIn Analytics', period: 'Jul 2023 — Oct 2024' },
    { value: '3 networks', label: 'ABC · Fox News · CBS', source: 'Broadcast placements', period: '2023–2024' },
  ],
  sections: [
    {
  ...
  faq: [
    {
      ...
      a: 'A narrative system for Mike Kaeding\'s CEO voice — positioning, LinkedIn cadence, executive presence, and the arc that connects his personal story to the mission on housing costs.',
    },
    {
      q: 'How did three networks end up calling?',
      a: 'Reporters searching for a builder-with-a-mission on housing costs kept finding Mike\'s content. The placements on ABC, Fox News and CBS were inbound.',
    },
  ],
  moreFrom: [],
  next: 'girish-sehgal',
