  ...
  return (
    <div style={{ backgroundColor: '#FFFFFF' }}>
      ...
      <section 
        ...
        style={{
          height: '70vh',
          backgroundImage: `linear-gradient(to top, rgba(0, 0, 0, 0.6), transparent 60%), url(${fourSeasonsLiving})`,
      ...
      <section 
        className="w-full"
        style={{ height: '50vh', backgroundImage: `url(${fourSeasonsExterior})`, backgroundSize: 'cover', backgroundPosition: 'center' }}
      />
      ...
      <section className="py-20 md:py-28 px-6 md:px-20" style={{ backgroundColor: '#F5F1E8' }}>
        <div className="max-w-[1000px] mx-auto">
          ...
          <div className="max-w-[500px] mx-auto">
            ...
            >
              <img src={fourSeasonsLinkedIn01} alt="LinkedIn post" className="w-full" loading="lazy" />
        ...
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {galleryImages.slice(1, 5).map((img, index) => (
              <img key={index} src={img.src} alt={img.caption} className="w-full" style={{ borderRadius: '8px', aspectRatio: '1/1', objectFit: 'cover' }} loading="lazy" />
            ))}
          </div>
        </div>
      </section>
