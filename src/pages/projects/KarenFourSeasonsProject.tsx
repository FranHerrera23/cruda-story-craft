          ...
          <div className="max-w-[540px] mx-auto mb-20">
            ...
            >
              <div style={{ padding: '16px' }}>
                <a 
                  href="https://www.instagram.com/reel/DKfa6ZgzlqC/?utm_source=ig_embed&utm_campaign=loading" 
                ...
                <p style={{ color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: '14px', lineHeight: '17px', marginBottom: 0, marginTop: '8px', overflow: 'hidden', padding: '8px 0 7px', textAlign: 'center', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                  <a href="https://www.instagram.com/reel/DKfa6ZgzlqC/?utm_source=ig_embed&utm_campaign=loading" style={{ color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: '14px', fontStyle: 'normal', fontWeight: 'normal', lineHeight: '17px', textDecoration: 'none' }} target="_blank" rel="noopener noreferrer">
                    A post shared by Karen Mannheim (@karen_mannheim)
                  </a>
                </p>
              </div>
            </blockquote>
