  ...
  return (
    <div style={{ backgroundColor: '#FFFFFF' }}>
      ...
      <section 
        ...
        style={{
          height: '70vh',
          backgroundImage: `linear-gradient(to top, rgba(0, 0, 0, 0.6), transparent 60%), url(${saadiyatHospitalityArea})`,
      ...
      <section 
        className="w-full"
        style={{ height: '50vh', backgroundImage: `url(${saadiyatVenueNight})`, backgroundSize: 'cover', backgroundPosition: 'center' }}
      />
